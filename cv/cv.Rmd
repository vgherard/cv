...
I am currently employed as Data Scientist in the Product Analytics division of 
[Voicemod](https://www.voicemod.net/), a software development company whose main 
focus are voice changing technologies. Here, my main tasks involve experimental 
design and coordination of A/B tests, analysis of complex user behavioral data, 
inference and predictive modeling around product decisions. In addition to 
that, a conspicuous part of my job involves providing support for 
data-engineering and reporting needs, especially on the data-modeling front.
